...
export const MacbookScroll = ({
  ...
  const screenBg = useColorModeValue("#717378", "#272729");

  return (
    <div
      ref={ref}
      className="min-h-[150vh] md:min-h-[200vh]  flex flex-col items-center py-0 md:py-60 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.6] sm:scale-50"
    >
      <motion.h2
        style={{
...
export const Lid = ({
  ...
  const screenBg = useColorModeValue("#F5F5F5", "#272729");
  return (
